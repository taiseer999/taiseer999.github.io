...
# ── TMDbHelper QR Auth blobs (by ABUKARIM TOOLS) ──
_TMDBH_QR_UTILS_B64 = ''
_TMDBH_XML_B64 = ''
_TMDBH_WHITE_PNG_B64 = 'iVBORw0KGgoAAAANSUhEUgAAAAgAAAAICAYAAADED76LAAAAFklEQVR4nGP8////fwY8gAmf5PBRAAAbbgQMid1tCwAAAABJRU5ErkJggg=='
_TMDBH_OLD_B64 = 'ICAgIGRlZiBsb2dpbihzZWxmKToKICAgICAgICBpZiBub3Qgc2VsZi51c2VyX2NvZGUgb3Igbm90IHNlbGYuZGV2aWNlX2NvZGU6CiAgICAgICAgICAgIHJldHVybgogICAgICAgIHNlbGYucG9sbGVyKCk='
_TMDBH_NEW_B64 = ''
_TMDBH_NEW_BLOCK = base64.b64decode(_TMDBH_NEW_B64).decode('utf-8')
...
PATCHES = [
    ...
    # ── TMDbHelper QR Auth (by ABUKARIM TOOLS) ──
    {
    ...
    },
    {
        ...
        'old': '', 'new': '',
        'description': 'TMDbHelper – inject white.png skin texture',
        'inject_file': True,
        'inject_content_b64': _TMDBH_WHITE_PNG_B64,
        'binary': True,
        'already_patched_check': None,
    },
    {
        ...
        'inject_file': True,
        'inject_content_b64': _TMDBH_XML_B64,
        # sentinel marks the current XML revision; bumping it forces an
        # overwrite of any older injected copy with the fixed backgrounds
        'already_patched_check': '<texture>white.png</texture>',
    },
    {
        # Repair 1: fix previously-injected broken import path
        'addon_id': 'plugin.video.themoviedb.helper',
        'rel_path': os.path.join('resources', 'tmdbhelper', 'lib', 'api', 'trakt', 'authenticator.py'),
        'old': 'from resources.tmdbhelper.lib.api.trakt.qr_utils import make_qr, remove_qr',
        'new': 'from tmdbhelper.lib.api.trakt.qr_utils import make_qr, remove_qr',
        'description': 'TMDbHelper authenticator.py - repair qr_utils import path',
        'not_found_ok': True,
        'fallback_pattern': None, 'fallback_repl': None,
    },
    {
        # Repair 2: replace ANY previously-injected QR login block (e.g. the
        # one using the invalid WindowXMLDialog.iscanceled()) with the current
        # corrected block. Regex spans from the patch start marker through the
        # _qr_login body's final self.auth_dialog_route() line.
        'addon_id': 'plugin.video.themoviedb.helper',
        'rel_path': os.path.join('resources', 'tmdbhelper', 'lib', 'api', 'trakt', 'authenticator.py'),
        'old': '',
        'new': '',
        'description': 'TMDbHelper authenticator.py - refresh QR auth block',
        'regex_only': True,
        'not_found_ok': True,
        'fallback_pattern': (
            r'    def login\(self\):\n'
            r'        if not self\.user_code or not self\.device_code:\n'
            r'            return\n'
            r'        # -- TMDbHelper QR Auth patch \(by ABUKARIM TOOLS\) --.*?'
            r'            self\.auth_dialog_route\(\)'
        ),
        'fallback_repl': lambda m: _TMDBH_NEW_BLOCK,
        # only skip if the corrected sentinel (canceled flag) already present
        'already_patched_check': 'qr_dialog.canceled',
    },
    {
        'addon_id': 'plugin.video.themoviedb.helper',
        'rel_path': os.path.join('resources', 'tmdbhelper', 'lib', 'api', 'trakt', 'authenticator.py'),
        'old': base64.b64decode(_TMDBH_OLD_B64).decode('utf-8'),
        'new': base64.b64decode(_TMDBH_NEW_B64).decode('utf-8'),
        'description': 'TMDbHelper authenticator.py - QR auth dialog',
        'already_patched_check': '# -- TMDbHelper QR Auth patch (by ABUKARIM TOOLS) --',
        'fallback_pattern': None, 'fallback_repl': None,
    },
]
