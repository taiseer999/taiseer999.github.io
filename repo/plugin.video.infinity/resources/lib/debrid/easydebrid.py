...
class EasyDebrid:
	...
	def __init__(self):
		...
		self.api_key = getSetting('easydebrid.token')
	...
	def auth(self):
		...
		control.setSetting('easydebrid.username', customer)
		control.notification(message='EasyDebrid succesfully authorized', icon=ed_icon)
		return True
