...
from resources.lib.modules.control import dialog, multiSelect, setSetting
...
class Hosted:
	...
	def configure(self):
		try:
			...
			if indexers:
				preselect = []
				ret = multiSelect('Select indexers:', indexers, preselect=preselect)
			...
			ret = multiSelect('Select languages:', languages, preselect=[0])
			if ret is None: return
