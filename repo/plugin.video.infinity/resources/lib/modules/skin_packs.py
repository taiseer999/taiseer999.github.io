# -*- coding: utf-8 -*-
"""
	OneMoar Add-on (added by OneMoar Dev 01/07/23 Updated 1/21/23)
"""
...
class iconPackHandler:
	...
	def set_active_skin_pack(self, skinpack):
		...
		control.setSetting('skin.packicons', str(skinpack))
		control.openSettings('0.0', 'plugin.video.infinity')
