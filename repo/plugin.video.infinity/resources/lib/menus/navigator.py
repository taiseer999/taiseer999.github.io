...
from resources.lib.indexers.trakt import getTraktCredentialsInfo, getTraktIndicatorsInfo
...
class Navigator:
	...
	def root(self):
		if self.traktCredentials and self.traktIndicators:
			self.addDirectoryItem(32037, 'calendar&url=progress&folderName=%s' % quote_plus(getLS(32037)), 'trakt.png', 'trakt.png', queue=True)
		self.addDirectoryItem(f"{getLS(32002)} {getLS(32442)}", 'tvshows&url=trakttrending&folderName=%s' % quote_plus(getLS(32442)), 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem(f"{getLS(32001)} {getLS(32442)}", 'movies&url=trakttrending&folderName=%s' % quote_plus(getLS(32442)), 'movies.png', 'DefaultMovies.png')
		...
		if getMenuEnabled('navi.anime'): self.addDirectoryItem('Discover Anime', 'anime_Navigator&folderName=%s' % quote_plus('Anime'), 'boxsets.png', 'DefaultFolder.png')
		...
		if any((self.favoriteMovie, self.favoriteTVShows, self.favoriteEpisodes)):
			self.addDirectoryItem(40464, 'favouriteNavigator&folderName=%s' % quote_plus(getLS(40464)), 'highly-rated.png', 'DefaultFolder.png')
...
#		self.addDirectoryItem(32010, 'tools_searchNavigator&folderName=%s' % quote_plus(getLS(32010)), 'search.png', 'DefaultAddonsSearch.png')
		self.addDirectoryItem(32008, 'tools_toolNavigator&folderName=%s' % quote_plus(getLS(32008)), 'tools.png', 'DefaultAddonProgram.png')
		...
		if getMenuEnabled('navi.changelog'): self.addDirectoryItem(32014, 'tools_ShowChangelog&name=Infinity', 'userlists.png', 'DefaultAddonHelper.png', isFolder=False)
		self.endDirectory()
	...
	def movies(self, lite=False, folderName=''):
		...
		if getMenuEnabled('navi.movie.simkl.trendingweek'):
			self.addDirectoryItem(40352 if self.indexLabels else 40353, 'movies&url=simkltrendingweek&folderName=%s' % quote_plus(getLS(40352 if self.indexLabels else 40353)), 'simkl.png' if self.iconLogos else 'trending.png', 'trending.png')
		if getMenuEnabled('navi.movie.tmdb.trendingday'):
			self.addDirectoryItem(40330 if self.indexLabels else 32442, 'tmdbmovies&url=tmdb_trendingday&folderName=%s' % quote_plus(getLS(40330 if self.indexLabels else 32442)), 'tmdb.png' if self.iconLogos else 'trending.png', 'DefaultTVShows.png')
		if getMenuEnabled('navi.movie.tmdb.trendingweek'):
			self.addDirectoryItem(40331 if self.indexLabels else 32442, 'tmdbmovies&url=tmdb_trendingweek&folderName=%s' % quote_plus(getLS(40331 if self.indexLabels else 32442)), 'tmdb.png' if self.iconLogos else 'trending.png', 'DefaultTVShows.png')
		...
		if getMenuEnabled('navi.movie.getdvdrelease'):
			self.addDirectoryItem(40474 if self.indexLabels else 40475, 'dvdreleaselistMovies&url=dvd_release_list&folderName=%s' % quote_plus(getLS(40474 if self.indexLabels else 40475)), 'tmdb.png' if self.iconLogos else 'trending.png', 'DefaultMovies.png')
...
#		if getMenuEnabled('navi.movie.trakt.recentlywatched') and self.traktCredentials:
#			self.addDirectoryItem(40255 if self.indexLabels else 40256, 'moviesBasedOn&url=tmdb_recommendations&folderName=%s' % quote_plus(getLS(40255 if self.indexLabels else 40256)), 'trakt.png' if self.iconLogos else 'years.png', 'DefaultMovies.png')
#		if getMenuEnabled('navi.movie.trakt.traktsimilar') and self.traktCredentials:
#			self.addDirectoryItem(40260 if self.indexLabels else 40261, 'moviesBasedOn&url=tmdb_similar&folderName=%s' % quote_plus(getLS(40260 if self.indexLabels else 40261)), 'trakt.png' if self.iconLogos else 'years.png', 'DefaultMovies.png')
	...
	def mymovies(self, lite=False, folderName=''):
		...
		if self.traktCredentials:
			self.addDirectoryItem(32033, 'movies&url=traktwatchlist&folderName=%s' % quote_plus(getLS(32033)), 'trakt.png', 'trakt.png')
			...
			if self.traktIndicators:
				self.addDirectoryItem(40256, 'moviesBasedOn&url=tmdb_recommendations&folderName=%s' % quote_plus(getLS(40256)), 'trakt.png' if self.iconLogos else 'years.png', 'DefaultMovies.png')
				self.addDirectoryItem(40261, 'moviesBasedOn&url=tmdb_similar&folderName=%s' % quote_plus(getLS(40261)), 'trakt.png' if self.iconLogos else 'years.png', 'DefaultMovies.png')
	...
	def tvshows(self, lite=False, folderName=''):
		...
		if getMenuEnabled('navi.tv.simkl.trendingweek'):
			self.addDirectoryItem(40352 if self.indexLabels else 40353, 'tvshows&url=simkltrendingweek&folderName=%s' % quote_plus(getLS(40352 if self.indexLabels else 40353)), 'simkl.png' if self.iconLogos else 'trending.png', 'DefaultTVShows.png')
		if getMenuEnabled('navi.tv.tmdb.trendingday'):
			self.addDirectoryItem(40330 if self.indexLabels else 32442, 'tmdbTvshows&url=tmdb_trendingday&folderName=%s' % quote_plus(getLS(40354 if self.indexLabels else 40355)), 'tmdb.png' if self.iconLogos else 'trending.png', 'DefaultTVShows.png')
		if getMenuEnabled('navi.tv.tmdb.trendingweek'):
			self.addDirectoryItem(40331 if self.indexLabels else 32442, 'tmdbTvshows&url=tmdb_trendingweek&folderName=%s' % quote_plus(getLS(40331 if self.indexLabels else 324425)), 'tmdb.png' if self.iconLogos else 'trending.png', 'DefaultTVShows.png')
		self.addDirectoryItem('Trending Anime (Simkl)', 'tvshows&url=simkl_animetrending&folderName=%s' % 'Trending Anime', 'tvshows.png', 'DefaultTVShows.png')
...
#		if getMenuEnabled('navi.tv.trakt.recentlywatched') and self.traktCredentials:
#			self.addDirectoryItem(40255 if self.indexLabels else 40256, 'tvBasedOn&url=tmdb_recommendations&folderName=%s' % quote_plus(getLS(40255 if self.indexLabels else 40256)), 'trakt.png' if self.iconLogos else 'years.png', 'DefaultTVShows.png')
#		if getMenuEnabled('navi.tv.trakt.traktsimilar') and self.traktCredentials:
#			self.addDirectoryItem(40260 if self.indexLabels else 40261, 'tvBasedOn&url=tmdb_similar&folderName=%s' % quote_plus(getLS(40260 if self.indexLabels else 40261)), 'trakt.png' if self.iconLogos else 'years.png', 'DefaultMovies.png')
	...
	def mytvshows(self, lite=False, folderName=''):
		...
		if self.traktCredentials:
			...
			self.addDirectoryItem(32033, 'tvshows&url=traktwatchlist&folderName=%s' % quote_plus(getLS(32033)), 'trakt.png', 'trakt.png')
			self.addDirectoryItem(32032, 'tvshows&url=traktcollection&folderName=%s' % quote_plus(getLS(32032)), 'trakt.png', 'trakt.png')
			if self.traktIndicators:
				self.addDirectoryItem(32037, 'calendar&url=progress&folderName=%s' % quote_plus(getLS(32037)), 'trakt.png', 'trakt.png', queue=True)
				self.addDirectoryItem(40401, 'traktProgress&url=progresstv&mediatype=progress&folderName=%s' % quote_plus(getLS(40401)), 'trakt.png', 'trakt.png', queue=True)
				self.addDirectoryItem(40433, 'traktProgress&url=progresstv&mediatype=watched&folderName=%s' % quote_plus(getLS(40433)), 'trakt.png', 'trakt.png', queue=True)
				...
				self.addDirectoryItem(40256, 'tvBasedOn&url=tmdb_recommendations&folderName=%s' % quote_plus(getLS(40256)), 'trakt.png' if self.iconLogos else 'years.png', 'DefaultTVShows.png')
				self.addDirectoryItem(40261, 'tvBasedOn&url=tmdb_similar&folderName=%s' % quote_plus(getLS(40261)), 'trakt.png' if self.iconLogos else 'years.png', 'DefaultMovies.png')
...
#		self.addDirectoryItem(32002, 'anime_TVshows&url=anime&folderName=%s' % quote_plus(getLS(32002)), 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem('Series Calendar (Trakt)', 'calendar&url=animecalendar&folderName=%s' % 'Calendar', 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem('Series Popular This Week (Simkl)', 'tvshows&url=simkl_animeweek&folderName=%s' % 'Series Popular This Week', 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem('Series Most Watched This Month (Simkl)', 'tvshows&url=simkl_animebest&folderName=%s' % 'Series Most Watched This Month', 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem('Series Most Voted This Month (Simkl)', 'tvshows&url=simkl_animevote&folderName=%s' % 'Series Most Voted This Month', 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem('Series Released Recently (Simkl)', 'tvshows&url=simkl_animedate&folderName=%s' % 'Series Released Recently', 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem('Series Genres (Simkl)', 'tvGenres&url=simkl_animegenre&folderName=%s' % 'Series Genres', 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem('ONAs Popular This Week (SIMKL)' if self.indexLabels else 'ONAs Popular This Week', 'tvshows&url=simkl_onasweek', 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem('ONAs Top Ranked (SIMKL)' if self.indexLabels else 'ONAs Top Ranked', 'tvshows&url=simkl_onasrank', 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem('ONAs Recently Released (SIMKL)' if self.indexLabels else 'ONAs Recently Released', 'tvshows&url=simkl_onasdate', 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem('Movies Popular This Week (Simkl)', 'movies&url=simkl_animeweek&folderName=%s' % 'Movies Popular This Week', 'movies.png', 'DefaultMovies.png')
		self.addDirectoryItem('Movies Most Watched This Month (Simkl)', 'movies&url=simkl_animebest&folderName=%s' % 'Movies Most Watched This Month', 'movies.png', 'DefaultMovies.png')
		self.addDirectoryItem('Movies Most Voted This Month (Simkl)', 'movies&url=simkl_animevote&folderName=%s' % 'Movies Most Voted This Month', 'movies.png', 'DefaultMovies.png')
		self.addDirectoryItem('Movies Released Recently (Simkl)', 'movies&url=simkl_animedate&folderName=%s' % 'Movies Released Recently', 'movies.png', 'DefaultMovies.png')
		self.addDirectoryItem('Movies Genres (Simkl)', 'movieGenres&url=simkl_animegenre&folderName=%s' % 'Movies Genres', 'movies.png', 'DefaultMovies.png')
		if self.useContainerTitles: control.setContainerName(folderName)
		self.endDirectory()
	...
	def trakt_genre(self, mediatype='', genre='',url='',lite=False, folderName=''):
		...
		self.addDirectoryItem(getLS(40499) % (genre, displayMediaType), 'trakt_genre&listtype=decades&mediatype=%s&genre=%s&url=%s&folderName=%s' % (mediatype, genre, url, quote_plus(getLS(40499) % (genre, displayMediaType))), 'trakt.png', 'trakt.png', queue=True)
		if self.useContainerTitles: control.setContainerName(folderName)
		self.endDirectory()
	...
	def trakt_decades(self, mediatype='', genre='',url='',lite=False, folderName=''):
		...
		if mediatype == 'TVShows':
			...
			displayMediaType = 'Movies'
		for i in ('2020-2029', '2010-2019', '2000-2009', '1990-1999', '1980-1989', '1970-1979', '1960-1969', '1950-1959', '1940-1949', '1930-1939'):
	...
	def traktSearchLists(self, media_type):
		...
		control.closeAll()
		if media_type == 'movies': control.execute('ActivateWindow(Videos,plugin://plugin.video.infinity/?action=movies_PublicLists&url=%s,return)' % (quote_plus(url)))
		else: control.execute('ActivateWindow(Videos,plugin://plugin.video.infinity/?action=tv_PublicLists&url=%s,return)' % (quote_plus(url)))
	...
	def tools(self, folderName=''):
		...
		self.addDirectoryItem(32510, 'cache_Navigator&folderName=%s' % quote_plus(getLS(40462)), 'tools.png', 'DefaultAddonService.png', isFolder=True)
		...
		#self.addDirectoryItem(32506, 'tools_contextInfinitySettings', 'icon.png', 'DefaultAddonProgram.png', isFolder=False)
		#-- Providers - 
		...
		self.addDirectoryItem(40452, 'tools_openSettings&query=8.0', 'tools.png', 'DefaultAddonService.png', isFolder=False)
		#-- Accounts - 7
		self.addDirectoryItem(32044, 'tools_openSettings&query=9.0', 'tools.png', 'DefaultAddonService.png', isFolder=False)
		self.addDirectoryItem(40124, 'tools_openSettings&query=10.0', 'tools.png', 'DefaultAddonService.png', isFolder=False)
		self.addDirectoryItem(40123, 'tools_openSettings&query=11.0', 'tools.png', 'DefaultAddonService.png', isFolder=False)
		#-- Downloads - 10
	...
	def loggingNavigator(self, folderName=''):
		self.addDirectoryItem(32524, 'tools_viewLogFile&name=Infinity', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
		self.addDirectoryItem(32525, 'tools_clearLogFile', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
		self.addDirectoryItem(32526, 'tools_ShowChangelog&name=Infinity', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
		self.addDirectoryItem(32527, 'tools_uploadLogFile&name=Infinity', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
	...
	def cf(self, folderName=''):
		self.addDirectoryItem(getLS(32610) % self.highlight_color, 'cache_clearAll', 'tools.png', 'DefaultAddonService.png', isFolder=False)
		self.addDirectoryItem(getLS(32611) % self.highlight_color, 'cache_clearSources', 'tools.png', 'DefaultAddonService.png', isFolder=False)
		self.addDirectoryItem(getLS(32612) % self.highlight_color, 'cache_clearMeta', 'tools.png', 'DefaultAddonService.png', isFolder=False)
		self.addDirectoryItem(getLS(32613) % self.highlight_color, 'cache_clearCache', 'tools.png', 'DefaultAddonService.png', isFolder=False)
		self.addDirectoryItem(getLS(32614) % self.highlight_color, 'cache_clearSearch', 'tools.png', 'DefaultAddonService.png', isFolder=False)
		self.addDirectoryItem(getLS(32615) % self.highlight_color, 'cache_clearBookmarks', 'tools.png', 'DefaultAddonService.png', isFolder=False)
		self.addDirectoryItem(getLS(40402) % self.highlight_color, 'cache_clearMovieCache', 'tools.png', 'DefaultAddonService.png', isFolder=False)
		self.addDirectoryItem(getLS(40078) % self.highlight_color, 'cache_clearThumbnails', 'tools.png', 'DefaultAddonService.png', isFolder=False)
		if self.useContainerTitles: control.setContainerName(folderName)
		self.endDirectory()
	...
	def favourites(self, folderName=''):
		if self.favoriteMovie: self.addDirectoryItem(getLS(40465), 'movies_favourites&folderName=%s' % (quote_plus(getLS(40465))), 'movies.png', 'DefaultMovies.png')
		if self.favoriteTVShows: self.addDirectoryItem(getLS(40466), 'shows_favourites&folderName=%s' % (quote_plus(getLS(40466))), 'tvshows.png', 'DefaultTVShows.png')
		if self.favoriteEpisodes: self.addDirectoryItem(getLS(40467), 'episodes_favourites&folderName=%s' % (quote_plus(getLS(40467))), 'tvshows.png', 'DefaultTVShows.png')
		if self.useContainerTitles: control.setContainerName(folderName)
		self.endDirectory()
	...
	def premium_services(self, folderName=''):
		...
		if getMenuEnabled('navi.offcloud'): self.addDirectoryItem(35533, 'oc_ServiceNavigator&folderName=%s' % quote_plus(getLS(35533)), 'offcloud.png', 'offcloud.png')
		...
		if getMenuEnabled('navi.torbox'): self.addDirectoryItem(35537, 'tb_ServiceNavigator&folderName=%s' % quote_plus(getLS(35537)), 'torbox.png', 'torbox.png')
		if self.useContainerTitles: control.setContainerName(folderName)
		self.endDirectory()
	...
	def alldebrid_service(self, folderName=''):
		if getSetting('alldebridtoken'):
			...
			self.addDirectoryItem('[I]Please setup in Accounts[/I]', 'tools_openSettings&query=9.0', 'alldebrid.png', 'DefaultAddonService.png', isFolder=False)
		if self.useContainerTitles: control.setContainerName(folderName)
		self.endDirectory()
	...
	def easynews_service(self, folderName=''):
		if getSetting('easynews.user'):
			...
			self.addDirectoryItem('[I]Please setup in Accounts[/I]', 'tools_openSettings&query=8.2', 'easynews.png', 'DefaultAddonService.png', isFolder=False)
		if self.useContainerTitles: control.setContainerName(folderName)
		self.endDirectory()
	...
	def premiumize_service(self, folderName=''):
		if getSetting('premiumizetoken'):
			...
			self.addDirectoryItem('[I]Please setup in Accounts[/I]', 'tools_openSettings&query=9.2', 'premiumize.png', 'DefaultAddonService.png', isFolder=False)
		if self.useContainerTitles: control.setContainerName(folderName)
		self.endDirectory()
	...
	def realdebrid_service(self, folderName=''):
		if getSetting('realdebridtoken'):
			...
			self.addDirectoryItem('[I]Please setup in Accounts[/I]', 'tools_openSettings&query=9.3', 'realdebrid.png', 'DefaultAddonService.png', isFolder=False)
		if self.useContainerTitles: control.setContainerName(folderName)
		self.endDirectory()
	...
	def torbox_service(self):
		if getSetting('torboxtoken'):
			...
			self.addDirectoryItem('[I]Please setup in Accounts[/I]', 'tools_openSettings&query=9.4', 'torbox.png', 'DefaultAddonService.png', isFolder=False)
		self.endDirectory()
	...
	def views(self, folderName=''):
		try:
			...
			title = getLS(32059)
			url = 'plugin://plugin.video.infinity/?action=tools_addView&content=%s' % content
			poster, banner, fanart = control.addonPoster(), control.addonBanner(), control.addonFanart()
			item = control.item(label=title, offscreen=True)
			item.setInfo(type='video', infoLabels = {'title': title}) if control.getKodiVersion() < 20 else item.getVideoInfoTag().setTitle(title)
	...
	def addDirectoryItem(self, name, query, poster, icon, context=None, queue=False, isAction=True, isFolder=True, isPlayable=False, isSearch=False, table=''):
		try:
			...
			url = 'plugin://plugin.video.infinity/?action=%s' % query if isAction else query
			...
			if queue: cm.append((queueMenu, 'RunPlugin(plugin://plugin.video.infinity/?action=playlist_QueueItem)'))
			if context: cm.append((getLS(context[0]), 'RunPlugin(plugin://plugin.video.infinity/?action=%s)' % context[1]))
			if isSearch: cm.append(('Clear Search Phrase', 'RunPlugin(plugin://plugin.video.infinity/?action=cache_clearSearchPhrase&source=%s&name=%s)' % (table, quote_plus(name))))
			cm.append(('[COLOR FFE68B00]Infinity Settings[/COLOR]', 'RunPlugin(plugin://plugin.video.infinity/?action=tools_openSettings)'))
			...
			item.setInfo(type='video', infoLabels={'plot': name}) if control.getKodiVersion() < 20 else item.getVideoInfoTag().setPlot(name)
