...
class Navigator:
	...
	def movies(self, lite=False, folderName=''):
		...
		if getMenuEnabled('navi.movie.getdvdrelease'):
			self.addDirectoryItem(40474 if self.indexLabels else 40475, 'dvdreleaselistMovies&folderName=%s' % quote_plus(getLS(40474 if self.indexLabels else 40475)), 'tmdb.png' if self.iconLogos else 'trending.png', 'DefaultMovies.png')
	...
	def tvshows(self, lite=False, folderName=''):
		...
		self.addDirectoryItem('Trending Anime (Simkl)', 'simklTvshows&url=simkl_animetrending&folderName=%s' % 'Trending Anime', 'tvshows.png', 'DefaultTVShows.png')
...
#		self.addDirectoryItem(32002, 'anime_TVshows&url=anime&folderName=%s' % quote_plus(getLS(32002)), 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem('Movies Popular This Week (Simkl)', 'simklMovies&url=simkl_animeweek&folderName=%s' % 'Movies Popular This Week', 'movies.png', 'DefaultMovies.png')
		self.addDirectoryItem('Movies Most Watched This Month (Simkl)', 'simklMovies&url=simkl_animebest&folderName=%s' % 'Movies Most Watched This Month', 'movies.png', 'DefaultMovies.png')
		self.addDirectoryItem('Movies Most Voted This Month (Simkl)', 'simklMovies&url=simkl_animevote&folderName=%s' % 'Movies Most Voted This Month', 'movies.png', 'DefaultMovies.png')
		self.addDirectoryItem('Movies Released Recently (Simkl)', 'simklMovies&url=simkl_animedate&folderName=%s' % 'Movies Released Recently', 'movies.png', 'DefaultMovies.png')
		...
		self.addDirectoryItem('Series Popular This Week (Simkl)', 'simklTvshows&url=simkl_animeweek&folderName=%s' % 'Series Popular This Week', 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem('Series Most Watched This Month (Simkl)', 'simklTvshows&url=simkl_animebest&folderName=%s' % 'Series Most Watched This Month', 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem('Series Most Voted This Month (Simkl)', 'simklTvshows&url=simkl_animevote&folderName=%s' % 'Series Most Voted This Month', 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem('Series Released Recently (Simkl)', 'simklTvshows&url=simkl_animedate&folderName=%s' % 'Series Released Recently', 'tvshows.png', 'DefaultTVShows.png')
		...
		self.addDirectoryItem('ONAs Popular This Week (SIMKL)' if self.indexLabels else 'ONAs Popular This Week', 'simklTvshows&url=simkl_onasweek', 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem('ONAs Top Ranked (SIMKL)' if self.indexLabels else 'ONAs Top Ranked', 'simklTvshows&url=simkl_onasrank', 'tvshows.png', 'DefaultTVShows.png')
		self.addDirectoryItem('ONAs Recently Released (SIMKL)' if self.indexLabels else 'ONAs Recently Released', 'simklTvshows&url=simkl_onasdate', 'tvshows.png', 'DefaultTVShows.png')
		if self.useContainerTitles: control.setContainerName(folderName)
		self.endDirectory()
