...
# added to Infinity as internal scraper 09/27/23
"""
	OneMoar Addon
"""
...
from resources.lib.debrid import plex as plexShare
...
class source:
	...
	def sources(self, data, hostDict):
		...
		try:
			...
			for share in shares:
				append(Thread(target=self.get_sources, args=(share[0], share[1], share[2], data)))
