...
class CoreScraper(object):
    ...
    def _find_url(self):
        ...
        if self.caller_name in ['anirena', 'btdig', 'bt4g', 'btscene', 'glo', 'eztv', 'lime', 'rutor', 'torrentapi', 'torrentz2', 'showrss', 'scenerls', 'piratebay', 'magnetdl', 'comet', 'mediafusion', 'meteor', 'torrentio', 'torrentioelf']:
