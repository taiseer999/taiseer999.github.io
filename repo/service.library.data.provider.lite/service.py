...
class Main:
    def __init__(self):
        ...
        # it should stop now
        self._init_vars()
        self.WINDOW.clearProperty('LibraryDataProviderLite_Running')
        ...
        self.WINDOW.setProperty('LibraryDataProviderLite_Running', 'true')
    ...
    def _daemon(self):
        ...
        count = 0
        while not self.Monitor.abortRequested() and self.WINDOW.getProperty('LibraryDataProviderLite_Running') == 'true':
