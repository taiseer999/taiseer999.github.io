...
(
    ...
    "script-altus-widget_movies",
    "script-altus-widget_tvshows",
    "script-altus-widget_custom1",
    "script-altus-widget_custom2",
    "script-altus-widget_custom3",
)
(
    ...
    "script-altus-main_menu_movies",
    "script-altus-main_menu_tvshows",
    "script-altus-main_menu_custom1",
    "script-altus-main_menu_custom2",
    "script-altus-main_menu_custom3",
)
default_xmls = {
    ...
    def manage_action(self, cpath_setting, context="widget"):
        ...
        if action in ["move_up", "move_down"]:
            ...
            if len(parts) < 3 or not parts[-1].isdigit():
                dialog.ok("Altus", "Cannot move this widget")
                return None
            ...
            if result:
                ...
                if context == "widget":
                    ...
                    self.make_main_menu_xml(self.fetch_current_cpaths())
                    dialog.ok("Altus", "Main menu remade")
    ...
    def create_and_update_widget(
        ...
        if widget_type[0] == "Category" and dialog.yesno(
            ...
            widget_type = self.widget_type(
                ...
                type_limit=len(stacked_widget_types),
                types=stacked_widget_types,
            )
