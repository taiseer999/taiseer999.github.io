...
class Config:
    ...
    def init_paths(self):
        ...
        self.MODURL = 'http://mirrors.kodi.tv/addons/piers/'
        self.MODURL_OMEGA = 'http://mirrors.kodi.tv/addons/omega/'
        self.MODURL_NEXUS = 'http://mirrors.kodi.tv/addons/nexus/'
        self.MODURL_MATRIX = 'http://mirrors.kodi.tv/addons/matrix/'
