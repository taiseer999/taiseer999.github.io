...
from .dataconn import create_conn, clear_db, clear_h1_db, clear_h2_db, optimize_db
...
def cl_allhistory():
        ...
        if 'Fen' in addon_select:
            ...
            if xbmcvfs.exists(maincache):
                ...
                with conn:
                    clear_h1_db(conn, '%movies_search%', 'maincache')
                    clear_h1_db(conn, '%movie_queries%', 'maincache')
        ...
        if 'Umbrella' in addon_select:
            ...
            if xbmcvfs.exists(history):
                ...
                with conn:
                    ...
                    clear_h2_db(conn, 'movies', 'sqlite_sequence')
        ...
        if 'Homelander' in addon_select:
            ...
            if xbmcvfs.exists(history):
                ...
                with conn:
                    ...
                    clear_h2_db(conn, 'people', 'sqlite_sequence')
                    optimize_db(conn, history)
            else:
                pass
        else:
