...
class source:
	...
	def _headers(self):
		return {'x-aiostreams-user-data': (
			...
			'ICAgIm9wdGlvbnMiOiB7Im5hbWUiOiAiQml0bWFnbmV0IiwgInRpbWVvdXQiOiA2NTAwLCAibWVkaWFU'
			'eXBlcyI6IFtdfQogICAgfQogIF0sCiAgImZvcm1hdHRlciI6IHsKICAgICJpZCI6ICJ0b3JyZW50aW8i'
			'LAogICAgImRlZmluaXRpb24iOiB7Im5hbWUiOiAiIiwgImRlc2NyaXB0aW9uIjogIiJ9CiAgfSwKICAi'
			'c29ydENyaXRlcmlhIjogeyJnbG9iYWwiOiBbXX0KfQ=='
		)}
