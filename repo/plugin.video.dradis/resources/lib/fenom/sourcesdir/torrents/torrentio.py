...
class source:
	...
	def __init__(self):
		...
		self.movieSearch_link = '/providers=yts,eztv,rarbg,1337x,thepiratebay,kickasstorrents,torrentgalaxy,magnetdl,rutor|language=english/stream/movie/%s.json'
		self.tvSearch_link = '/providers=yts,eztv,rarbg,1337x,thepiratebay,kickasstorrents,torrentgalaxy,magnetdl,rutor|language=english/stream/series/%s:%s:%s.json'
		self.min_seeders = 0
