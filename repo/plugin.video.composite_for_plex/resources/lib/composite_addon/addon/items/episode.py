...
def create_episode_item(context, item, library=False):
    ...
    prefix_sxee = (item.tree.get('mixedParents') == '1' or context.settings.episode_sort_method() == 'plex')
    prefix_tvshow = (item.tree.get('parentIndex') != '1' and context.params.get('mode') == '0')
