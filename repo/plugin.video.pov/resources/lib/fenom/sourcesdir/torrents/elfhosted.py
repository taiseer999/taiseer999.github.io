	...
	def sources(self, data, hostDict):
		...
		for file in files:
			try:
				...
				name = source_utils.clean_name(file_title[1] if len(file_title) > 2 else file_title[0])
				...
				append({'provider': 'elfhosted', 'source': 'torrent', 'seeders': seeders, 'hash': hash, 'name': name, 'name_info': name_info, 'quality': quality,
