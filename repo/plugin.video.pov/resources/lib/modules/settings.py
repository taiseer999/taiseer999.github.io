...
default_internal_scrapers, cloud_scrapers = (
	'ad_cloud', 'pm_cloud', 'rd_cloud', 'tb_cloud', 'oc_cloud', 'easynews', 'folders'
...
def provider_sort_ranks():
	...
	return {
		...
		'easydebrid': ed_priority, 'easynews': en_priority,
		'folders': 0
	}
...
def scraping_settings():
	...
	return {
		...
		'offcloud': oc_highlight, 'oc_cloud': debrid_cloud_highlight,
