...
def build_episode_list(params):
	...
	watched_title = 'Trakt' if watched_indicators == 1 else 'gearsLAM'
...
def build_single_episode(list_type, params={}):
	def _get_category_name():
		try:
			cat_name = {'episode.progress': 'In Progress Episodes',
						...
						'episode.next_trakt': 'Next Episodes', 'episode.next_gears': 'Next Episodes',
	...
	if list_type == 'episode.next':
		...
		else: resformat, resinsert, list_type = '%Y-%m-%d %H:%M:%S', '2000-01-01 00:00:00', 'episode.next_gears'
