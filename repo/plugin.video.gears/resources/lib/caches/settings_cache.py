...
class SettingsCache:
	def get(self, setting_id):
		try:
			...
			setting_id = setting_id.replace('gears.', '')
	...
	def set_memory_cache(self, setting_id, setting_value):
		kodi_utils.set_property('gears.%s' % setting_id, setting_value)

	def delete_memory_cache(self, setting_id):
		clear_property('gears.%s' % setting_id)
...
def set_path(params):
	...
	new_value = kodi_utils.kodi_dialog().browse(browse_mode, '', '', defaultt=get_setting('gears.%s' % setting_id))
	set_setting(setting_id, new_value)
...
def set_source_folder_path(params):
	setting_id = params['setting_id']
	current_setting = get_setting('gears.%s' % setting_id)
...
def default_setting_values(setting_id):
	if 'gears.' in setting_id: setting_id = setting_id.replace('gears.', '')
	d_settings = default_settings()
...
#==================== Downloads
{'setting_id': 'movie_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.gears/Movies Downloads/', 'browse_mode': '0'},
{'setting_id': 'tvshow_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.gears/TV Show Downloads/', 'browse_mode': '0'},
{'setting_id': 'premium_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.gears/Premium Downloads/', 'browse_mode': '0'},
{'setting_id': 'image_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.gears/Image Downloads/', 'browse_mode': '0'},
...
{'setting_id': 'provider.pm_highlight', 'setting_type': 'string', 'setting_default': 'FF5D5D5D'},
...
{'setting_id': 'addon_icon_choice_name', 'setting_type': 'string', 'setting_default': 'gears_icon_01'},
