...
def adjust_personal_list_properties(params):
	...
	if action == 'list_name':
		...
		new_poster = personal_image_maker(current_name, 'poster', current_sort_order, custom_poster)
		...
		new_fanart = personal_image_maker(current_name, 'fanart', current_sort_order, custom_fanart)
