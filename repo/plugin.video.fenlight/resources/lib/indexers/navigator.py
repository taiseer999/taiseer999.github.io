...
class Navigator:
	...
	def maintenance(self):
		...
		self.add({'mode': 'clear_cache', 'cache': 'intros', 'isFolder': 'false'}, 'Clear Intros Cache', 'settings')
		...
		self.add({'mode': 'clear_cache', 'cache': 'pack_continuity', 'isFolder': 'false'}, 'Clear Episode Pack Cache', 'settings')
