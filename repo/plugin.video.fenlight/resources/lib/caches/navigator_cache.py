...
{'name': 'Highest Rated', 'mode': 'build_movie_list', 'action': 'tmdb_movies_highest_rated', 'random_support': 'true', 'iconImage': 'rated'},
{'name': 'Hidden Gems', 'mode': 'build_movie_list', 'action': 'tmdb_movies_hidden_gems', 'random_support': 'true', 'iconImage': 'gem'},
{'name': 'Quick Watches', 'mode': 'build_movie_list', 'action': 'tmdb_movies_quick_watches', 'random_support': 'true', 'iconImage': 'quick'},
...
{'name': 'Highest Rated', 'mode': 'build_tvshow_list', 'action': 'tmdb_tv_highest_rated', 'random_support': 'true', 'iconImage': 'rated'},
{'name': 'Hidden Gems', 'mode': 'build_tvshow_list', 'action': 'tmdb_tv_hidden_gems', 'random_support': 'true', 'iconImage': 'gem'},
{'name': 'Marathon-Worthy', 'mode': 'build_tvshow_list', 'action': 'tmdb_tv_marathon', 'random_support': 'true', 'iconImage': 'binge'},
...
{'name': 'Anime Highest Rated', 'mode': 'build_tvshow_list', 'action': 'tmdb_anime_highest_rated', 'random_support': 'true', 'iconImage': 'rated'},
{'name': 'Anime Hidden Gems', 'mode': 'build_tvshow_list', 'action': 'tmdb_anime_hidden_gems', 'random_support': 'true', 'iconImage': 'gem'},
{'name': 'Anime Marathon-Worthy', 'mode': 'build_tvshow_list', 'action': 'tmdb_anime_marathon', 'random_support': 'true', 'iconImage': 'binge'},
