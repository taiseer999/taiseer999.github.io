...
class TMDbListAPI:
	def __init__(self):
		...
		self.read_access_token = 'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI5ODhhMmFhOGIxMmY3ODk5ZDJjNjNkZGNkZTM3YTNhZiIsIm5iZiI6MTc3Nzk4MDE1MC4wMzYsInN1YiI6IjY5ZjlkMmY2MDEwZmQ1NWZiZWM5NWJiMyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.MlDfCiJvHORlZJ2nkSMAf3byie2yPRbFkNtLVhGjqoM'
	...
	def get_user_lists(self):
		...
		def _process(dummy):
			...
			return results
		account_id = get_setting('fenskeleton.tmdb.account_id')
	...
	def request_data(self, url, params=None, data=None, method='get'):
		headers = {'accept': 'application/json', 'content-type': 'application/json', 'Authorization': 'Bearer %s' % get_setting('fenskeleton.tmdb.token')}
