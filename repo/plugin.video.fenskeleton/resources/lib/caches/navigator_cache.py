...
class NavigatorCache:
	...
	{'name': 'Next Episodes', 'mode': 'build_next_episode', 'iconImage': 'next_episodes'},
		{'name': 'Random Next Episodes', 'mode': 'navigator.random_next_up_widget', 'iconImage': 'random'}
				]
	anime_list = [
	...
	def _get_list_prop(self, list_type):
		return {'default': 'fenskeleton_%s_default', 'edited': 'fenskeleton_%s_edited', 'shortcut_folder': 'fenskeleton_%s_shortcut_folder'}[list_type]
