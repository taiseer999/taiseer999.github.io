...
\n            <onclick>RunScript(plugin.video.fenskeleton,mode=re_search)</onclick>\
\n        </item>"
...
\n        </include>\
\n        <include content="{cpath_type}">\
\n            <param name="content_path" value="$INFO[Window(Home).Property(fenmage.{cpath_list_id}.path)]"/>\
\n            <param name="widget_header" value="$INFO[Window(Home).Property(fenmage.{cpath_list_id}.label)]"/>\
\n            <param name="widget_target" value="videos"/>\
