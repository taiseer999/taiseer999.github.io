...
def window_manager(obj):
	def close():
		obj.close()
		kodi_utils.clear_property('fenskeleton.window_loaded')
		kodi_utils.clear_property('fenskeleton.window_stack')

	def monitor():
		timer = 0
		while not kodi_utils.get_property('fenskeleton.window_loaded') == 'true' and timer <= 5:
			kodi_utils.sleep(50)
			timer += 0.05
	...
	def get_stack():
		try: window_stack = json.loads(kodi_utils.get_property('fenskeleton.window_stack'))
		except: window_stack = []
		return window_stack

	def add_to_stack(params):
		window_stack.append(params)
		kodi_utils.set_property('fenskeleton.window_stack', json.dumps(window_stack))
...
class BaseDialog(xbmcgui.WindowXMLDialog):
	...
	def set_home_property(self, prop, value):
		kodi_utils.set_property('fenskeleton.%s' % prop, value)

	def get_home_property(self, prop):
		return kodi_utils.get_property('fenskeleton.%s' % prop)

	def clear_home_property(self, prop):
		return kodi_utils.clear_property('fenskeleton.%s' % prop)
...
class FontUtils:
	def execute_custom_fonts(self, skin_files=[]):
		...
		if not skin_files:
			kodi_utils.set_property('fenskeleton.current_skin', self.current_skin)
			kodi_utils.set_property('fenskeleton.current_font', self.current_font)
		skin_files = skin_files or kodi_utils.list_dirs(kodi_utils.translate_path('special://home/addons/plugin.video.fenskeleton/resources/skins/Default/1080i/'))[1]
	...
	def skin_change_check(self):
		...
		if self.current_skin != kodi_utils.get_property('fenskeleton.current_skin') or self.current_font != kodi_utils.get_property('fenskeleton.current_font'): return True
		return False
	...
	def replace_font(self, window, replacement_values):
		file = kodi_utils.translate_path('special://home/addons/plugin.video.fenskeleton/resources/skins/Default/1080i/' + window)
...
class ExtrasUtils:
	...
	def run(self):
		...
		file = kodi_utils.translate_path('special://home/addons/plugin.video.fenskeleton/resources/skins/Default/1080i/%s' % skin_file)
				...
				<control type="group">
				    ...
				    <control type="group">
				        <control type="label">
				            ...
				            <height>20</height>
				            <font>font14</font> <!-- Fenlight-Skeleton_33 -->
				        ...
				        <control type="panel" id="{container_no}">
				            ...
				            <itemlayout height="380" width="590">
				                ...
				                <control type="textbox">
				                    ...
				                    <width>540</width>
				                    <height>308</height>
				                    <font>font12</font> <!-- Fenlight-Skeleton_26 -->
				                    <align>center</align>
				                    <aligny>top</aligny>
				                    <textcolor>FFCCCCCC</textcolor>
        ...
        <control type="group">
            ...
            <control type="group">
                ...
                <control type="image">
                    ...
                    <texture>$INFO[Window(10000).Property(fenskeleton.addon_icon_mini)]</texture>
                </control>
                <control type="group">
                    ...
                    <control type="label">
                        ...
                        <height>20</height>
                        <font>font37</font> <!-- Fenlight-Skeleton_38 -->
                        <textcolor>FFCCCCCC</textcolor>
                        <align>right</align>
                        <aligny>center</aligny>
                    ...
                    <control type="label">
                        ...
                        <height>20</height>
                        <font>font10</font> <!-- Fenlight-Skeleton_21 -->
                        <textcolor>FFCCCCCC</textcolor>
                        <align>right</align>
                        <aligny>center</aligny>
            ...
            <control type="group">
                ...
                <control type="group">
                    ...
                    <control type="label">
                        ...
                        <height>30</height>
                        <font>font60</font> <!-- Fenlight-Skeleton_60_BOLD -->
                        <textcolor>FFCCCCCC</textcolor>
                        <align>center</align>
                        <aligny>bottom</aligny>
