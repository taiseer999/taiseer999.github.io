...
class Movies:
	...
	def fetch_list(self):
		...
		try:
			...
			if page_no == 1 and not self.is_external: kodi_utils.set_property('fenskeleton.exit_params', kodi_utils.folder_path())
	...
	def build_movie_content(self, _position, _id):
		try:
			...
			set_properties({
				...
				'fenskeleton.extras_params': extras_params,
				'fenskeleton.options_params': options_params,
				'fenskeleton.playback_options_params': playback_options_params,
				'fenskeleton.browse_movie_set_params': browse_movie_set_params,
				'fenskeleton.browse_recommended_params': browse_recommended_params,
				'fenskeleton.browse_related_params': browse_related_params,
				'fenskeleton.browse_more_like_this_params': browse_more_like_this_params,
				'fenskeleton.browse_similar_params': browse_similar_params,
				'fenskeleton.browse_in_trakt_list_params': browse_in_trakt_list_params,
				'fenskeleton.trakt_manager_params': trakt_manager_params,
				'fenskeleton.personal_manager_params': personal_manager_params,
				'fenskeleton.tmdb_manager_params': tmdb_manager_params,
				'fenskeleton.favorites_manager_params': favorites_manager_params
				})
