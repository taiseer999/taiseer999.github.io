...
def get_menu_items(context):
    items = []
    menu_structure = [
        (i18n('Continue Watching TV'), MODES.CONTINUE_WATCHING_TV, '/library/continueWatchingTv', None),
        (i18n('Continue Watching Movies'), MODES.MOVIES_ON_DECK, '/library/onDeck', 'movie'),
        (i18n('Next Up TV'), MODES.NEXT_UP_TV, '/library/nextUpTv', None),
        (i18n('Watchlist'), MODES.MYPLEXWATCHLIST, 'http://myplexwatchlist', None),
        ('TV Shows on Deck (Legacy)', MODES.TVSHOWS_ON_DECK, '/library/onDeck', 'show'),
