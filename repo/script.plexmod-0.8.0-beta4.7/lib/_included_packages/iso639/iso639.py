...
def _fabtabular():
    ...
    data = os.path.join(dn, 'iso-639-3.tab')
    inverted = os.path.join(dn, 'iso-639-3_Name_Index.tab')
    macro = os.path.join(dn, 'iso-639-3-macrolanguages.tab')
    part5 = os.path.join(dn, 'iso639-5.tsv')
    part2 = os.path.join(dn, 'iso639-2.tsv')
    part1 = os.path.join(dn, 'iso639-1.tsv')
